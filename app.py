...
# --- LE PROGRAMME COMPLET DES 60 LEÇONS ---
PROGRAMME = {
    "Débutant": [
        {"titre": "L'Alphabet", "regle": "A [eɪ], E [iː], G [dʒ], J [dʒeɪ].", "ex": "Apple (Pomme)", "test": "Épelle 'cat' :", "rep": "cat"},
    ...
    "Intermédiaire": [
        ...
        {"titre": "Will (Futur)", "regle": "Will + verbe (décision/prédiction).", "ex": "It will rain (Il pleuvra)", "test": "I _ (help) you.", "rep": "will help"},
        ...
        {"titre": "Révision B2", "regle": "Validation intermédiaire.", "ex": "Good luck!", "test": "Traduis 'Hier' :", "rep": "yesterday"}
    ],
    "Avancé": [
        ...
        {"titre": "Wish / If Only", "regle": "Exprimer le regret.", "ex": "I wish I were... (Je voudrais être...)", "test": "I wish I _ (know).", "rep": "knew"},
        {"titre": "Have something done", "regle": "Faire faire quelque chose.", "ex": "I had my hair cut.", "test": "I had it _ (repair).", "rep": "repaired"},
        {"titre": "Inversion Emphase", "regle": "Never have I... / Seldom do we...", "ex": "Never have I seen such...", "test": "Seldom _ he go.", "rep": "does"},
        ...
        {"titre": "Nominalisation", "regle": "Transformer verbe en nom.", "ex": "Decision (from Decide)", "test": "Noun of 'Apply' :", "rep": "application"},
        {"titre": "Cleft Sentences", "regle": "What I need is... / It is... that.", "ex": "It is you that I love.", "test": "_ I want is water.", "rep": "what"},
        ...
        {"titre": "Idiomes", "regle": "Expressions figées.", "ex": "Piece of cake (Facile)", "test": "Under the _ (Malade).", "rep": "weather"},
        ...
        {"titre": "Accents", "regle": "UK vs US English.", "ex": "Flat (UK) / Apartment (US)", "test": "US for 'Lift' (Ascenseur) :", "rep": "elevator"},
        {"titre": "Argot / Slang", "regle": "Langage familier.", "ex": "Gonna (Going to)", "test": "Wanna -> Want _.", "rep": "to"},
        {"titre": "Examen Final", "regle": "Test de maîtrise C1.", "ex": "Well done!", "test": "Traduis 'Maîtrise' :", "rep": "mastery"}
    ]
}
...
if st.session_state.etape == "presentation":
    ...
    leçon = cours[st.session_state.leçon_index]
    
    st.sidebar.title("Clarisse Menu")
    st.sidebar.write(f"Niveau : {st.session_state.niveau}")
    st.sidebar.progress((st.session_state.leçon_index + 1) / len(cours))
    if st.sidebar.button("Changer de niveau"): st.session_state.etape, st.session_state.leçon_index = "presentation", 0; st.rerun()
    ...
    if st.button("Valider"):
        if ans == leçon['rep']:
            ...
            if st.session_state.leçon_index < len(cours) - 1:
                if st.button("Continuer ➡️"): st.session_state.leçon_index += 1; st.rerun()
            else:
                st.balloons(); st.success("Niveau complété ! Félicitations.")
        else: st.error("Réessaie !")
